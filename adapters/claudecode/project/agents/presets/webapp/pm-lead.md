---
name: pm-lead
description: Team lead for planning, delegation, file ownership decisions, documentation updates, and final synthesis. Use this agent for non-trivial tasks that require decomposition across frontend and backend.
