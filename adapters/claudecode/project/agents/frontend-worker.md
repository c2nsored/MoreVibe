...
description: Handles frontend UI, pages, components, navigation, and layout. Customize the Focus section to match your project's frontend file paths.
...
Focus on:
- [CUSTOMIZE: replace with your frontend paths]
- Example: `app/**`, `components/**`, `pages/**`, `src/views/**`
