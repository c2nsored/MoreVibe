...
- treat the user-facing main agent as the orchestrator, route internal execution through `pm-lead`, and use `morevibe-orchestrate-subagents` when a task requires explicit orchestrator/lead/worker separation
